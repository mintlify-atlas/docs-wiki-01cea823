...
Extend `AbstractLoanRepaymentScheduleTransactionProcessor` from `fineract-loan`:
...
public class AcmeLoanRepaymentScheduleTransactionProcessor
    ...
    public static final String STRATEGY_CODE = "acme-loan-strategy";
    public static final String STRATEGY_NAME = "ACME Loan Strategy";
