...
├── fineract-doc/                 ← documentation project (AsciiDoc / PDF generation)
...
`io.rest-assured` is pinned as a dependency set at version `5.5.7` (not a BOM). Key individual version pins: `org.postgresql:postgresql:42.7.11`, `com.mysql:mysql-connector-j:9.7.0`, `org.mariadb.jdbc:mariadb-java-client:3.5.8`, `org.liquibase:liquibase-core:4.33.0`, `org.mapstruct:mapstruct:1.6.3`, `org.apache.avro:avro:1.12.1`.
