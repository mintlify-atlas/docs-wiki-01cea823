...
description: "Reference for Fineract's core JPA entities: base classes, ExternalId type, entity relationships, EclipseLink static weaving, and validation error handling."
---
