...
description: "Architecture of Fineract's reporting engine: ReportingProcessService SPI, @ReportService annotation, report execution via RunreportsApiResource, scheduled email delivery, and MIX Market XBRL reporting."
---
...
| `previous_run_error_log` | `previousRunErrorLog` | |
...
| `GET` | `/v1/mixtaxonomymapping` | List GL → taxonomy mappings. |
| `PUT` | `/v1/mixtaxonomymapping` | Batch-update mappings (`MixTaxonomyMappingUpdateCommand`). |
