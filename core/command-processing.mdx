...
| `CommandProcessingService` | `commands/service/CommandProcessingService.java` | `processAndLogCommand(…)` |
...
sequenceDiagram
    ...
    PCW->>CPS: processAndLogCommand(wrapper, json)
    CPS->>Handler: processWithCheckerRejectionRequest(command)
