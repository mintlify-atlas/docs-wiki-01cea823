...
<Tabs>
  ...
  <Tab title="Kafka">
    ...
    **Worker listener** (`KafkaRemoteMessageListener`):
    ...
    public void onMessage(ContextualMessage contextualMessage, Acknowledgment acknowledgment) {
...
| `fineract.remote-job-message-handler.kafka.producer.extra-properties` | `FINERACT_REMOTE_JOB_MESSAGE_HANDLER_KAFKA_PRODUCER_EXTRA_PROPERTIES` | `""` | Pipe-separated extra producer props |
| `fineract.remote-job-message-handler.kafka.admin.extra-properties` | `FINERACT_REMOTE_JOB_MESSAGE_HANDLER_KAFKA_ADMIN_EXTRA_PROPERTIES` | `""` | Pipe-separated extra admin props |
| `fineract.remote-job-message-handler.kafka.consumer.extra-properties-separator` | `FINERACT_REMOTE_JOB_MESSAGE_HANDLER_KAFKA_CONSUMER_EXTRA_PROPERTIES_SEPARATOR` | `\|` | Separator between properties |
| `fineract.remote-job-message-handler.kafka.consumer.extra-properties-key-value-separator` | `FINERACT_REMOTE_JOB_MESSAGE_HANDLER_KAFKA_CONSUMER_EXTRA_PROPERTIES_KEY_VALUE_SEPARATOR` | `=` | Key/value separator within a property |
