...
| `fineract-branch/…/organisation/teller/domain/CashierTxnType.java` | fineract-branch | `ALLOCATE(101)`, `SETTLE(102)`, `INWARD_CASH_TXN(103)`, `OUTWARD_CASH_TXN(104)` constants |
